...
(606, 'Missing error handling prior to function: "{}" in file: "cs_lookup.cpp", line: "{}", Fix your handler in "HandleLookupPlayer%"', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
