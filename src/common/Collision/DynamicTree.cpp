...
bool DynamicMapTree::GetIntersectionTime(uint32 const phasemask, G3D::Ray const& ray, G3D::Vector3 const& endPos, float& maxDist) const
{
...
bool DynamicMapTree::GetObjectHitPos(uint32 const phasemask, G3D::Vector3 const& startPos,
