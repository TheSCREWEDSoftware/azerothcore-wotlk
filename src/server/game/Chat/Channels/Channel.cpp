...
void Channel::ToggleModeration(Player* player)
{
    ...
    AccountTypes const level = static_cast<AccountTypes>(sWorld->getIntConfig(CONFIG_GM_LEVEL_CHANNEL_MODERATION));
    bool const gm = (player->GetSession()->GetSecurity() >= level);
