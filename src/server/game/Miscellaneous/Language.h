...
enum AcoreStrings
{
    ...
    // Character inactive commands
    LANG_CHARACTER_INACTIVE_DISABLED    = 35465,
    LANG_CHARACTER_INACTIVE_ALREADY     = 35466,
    LANG_CHARACTER_INACTIVE_ADDED       = 35467,
    LANG_CHARACTER_INACTIVE_REMOVED     = 35468,
    LANG_CHARACTER_INACTIVE_LIST_HEADER = 35469,
    LANG_CHARACTER_INACTIVE_LIST_LINE   = 35470
};
#endif
