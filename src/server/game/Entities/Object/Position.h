...
struct Position
{
    ...
    [[nodiscard]] float GetExactDist2dSq(float const x, float const y) const
    {
    ...
    [[nodiscard]] float GetExactDist2d(float const x, float const y) const { return std::sqrt(GetExactDist2dSq(x, y)); }
