...
uint32 const SmartPhaseMask[SMART_EVENT_PHASE_COUNT][2] =
{
...
uint32 const SmartAITypeMask[SMART_SCRIPT_TYPE_MAX][2] =
{
...
uint32 const SmartAIEventMask[SMART_EVENT_AC_END][2] =
{
