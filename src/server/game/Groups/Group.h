...
static uint8 const GroupUpdateLength[GROUP_UPDATE_FLAGS_COUNT] = { 0, 2, 2, 2, 1, 2, 2, 2, 2, 4, 8, 8, 1, 2, 2, 2, 1, 2, 2, 8};
...
public:
    ...
    void   SetLfgRoles(ObjectGuid guid, uint8 const roles);
