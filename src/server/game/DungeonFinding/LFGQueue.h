...
namespace lfg
{
    ...
    */
    ...
    private:
        ...
        LfgCompatibility CheckCompatibility(Lfg5Guids const& checkWith, ObjectGuid const& newGuid, uint64& foundMask, uint32& foundCount, std::set const<Lfg5Guids>& currentCompatibles);
